...
function CommentDisplay({
  ...
  onClose,
  onAddComment,
  onAddReply, // ✅ This is handleAddReply from RepoCard
  isLoading,
}) {
  ...
  const submitReply = async (parentId, text) => {
    if (!text.trim()) return; // ✅ Check the 'text' argument now

    setIsSubmitting(true);
    await onAddReply(parentId, text); // ✅ Pass the correct 'text' argument
    
    // setReplyText(""); // ❌ No longer needed
    setReplyingTo(null); // ✅ Close the box
    setIsSubmitting(false);
  };
                ...
                >
                  ...
                  {replyingTo === comment._id && (
                    <ReplyBox
                      ...
                      onSubmit={submitReply} // ✅ This now works
