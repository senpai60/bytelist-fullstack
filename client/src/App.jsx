...
const user = {
  ...
  avatar: "https://images.unsplash.com/photo-1602471615287-d733c59b79c4?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1171",
  stats: {
    posts: 12,
    likes: 340,
    saved: 27,
    ...
    <main className="w-full h-screen bg-zinc-950">
     ...
     <div className="all-pages pt-20 md:pt-10">
      <Routes>
       ...
       <Route path="/add-repo-post" element={<RepoPostCreate user={user}/>} />
